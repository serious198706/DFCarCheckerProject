...
public class CarModifyViewPagerActivity extends FragmentActivity implements ActionBar
        .TabListener {
    ...
    public void quitCarCheck() {
        ...
        builder.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                // 退出
                Intent intent = new Intent(CarModifyViewPagerActivity.this, QueueScanService.class);
                stopService(intent);
    ...
    public void commit() {
        ...
        builder.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                // 将结构检查的图片加入到照片池
                mCommitProgressDialog = ProgressDialog.show(CarModifyViewPagerActivity.this, null,
                        "正在提交...", false, false);
    ...
    private BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            // 提交成功
            if(result.equals("0")) {
                Toast.makeText(CarModifyViewPagerActivity.this, "提交成功！", Toast.LENGTH_LONG).show();
            }

            // 停止服务
            Intent serviceIntent = new Intent(CarModifyViewPagerActivity.this, QueueScanService.class);
